      ...
      <Navbar />
        ...
        <div className= "Container1"  id="container1">
          <div style={{ position: 'relative' }}>
            ...
            <button className="AllButtons" data-tooltip="Connective Tissue septa" id="Thyroidbtn2" data-popup="popup2" onClick={() => openPopup1('/assets/Images/Thyroid/Connective_Tissue_Septa.png', 'The gland shows a thin capsule. Thin septae extend from the capsule into the substance of the gland and divide it into lobules. ', '/assets/Audios/Endocrine/Connective_tissue_septa.wav')}>2</button>
