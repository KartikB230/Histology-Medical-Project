      ...
      className='box'>
        ...
        <div className="Container1" id="container1">
          <div style={{ position: 'relative' }}>
            ...
            <button className="AllButtons" data-tooltip="Capsule" id="Adrenalbtn4" data-popup="popup4" onClick={() => openPopup1('/assets/Images/Adrenal/Zona_Glomerulose.png', '#', '#')}>4</button>
