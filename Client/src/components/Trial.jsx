...
const Trial = () => {
  ...
  const tiles = [
    ...
    { name: 'Bone', img: '/assets/Images/Bone/Ground Bone LS Low Magnification.jpg', link: '/Bone', keywords: ['TS Ground Bone', 'LS Ground Bone'] },
    { name: 'Blood Vessels', img: '/assets/Images/Blood Vessel/Elastic Artery Low Magnification.jpg', link: '/BloodVessel', keywords: ['Elastic Artery', 'Muscular Artery', 'Arteriole', 'Vein'] },
    ...
    { name: 'Salivary Gland', img: '/assets/Images/Salivary Gland/Mixed Salivary Gland Low Magnification.jpg', link: '/Salivary Gland', keywords: ['Saliva', 'Mixed Salivary Gland', 'Serous Salivary Gland', 'Mucous Salivary Gland'] },
        ...
        {listView ? (
          <div className="list-view">
            {filteredTiles.map(tile => (
              <Link key={tile.name} to={tile.link} className="list-item">
                {tile.name}
              </Link>
            ))}
          </div>
