      ...
      <div>
        ...
        <div className="Container1" id="container1" onTouchStart={handleTouchStart} onTouchMove={handleTouchMove} onTouchEnd={handleTouchEnd}>
          <div style={{ position: 'relative' }}>
            <img alt= ""  src="assets\Images\Epithelium\Transitional Epithelium Low Magnification.jpg" />
        ...
        <div className='Container2'>
          <a className="image-cell" onClick={() => openPopup1("assets/Images/Epithelium/Transitional Epithelium Relaxed Pencil.jpg")} style={{ display: "flex", justifyContent: "center", marginBottom: "10px" }}><strong><u>Click Here to view Pencil Diagram of Transitional Epithelium Relaxed</u></strong></a>
          <a className="image-cell" onClick={() => openPopup1("assets/Images/Epithelium/Transitional Epithelium Streched Pencil.jpg")} style={{ display: "flex", justifyContent: "center", marginBottom: "10px" }}><strong><u>Click Here to view Pencil Diagram of Transitional Epithelium Streched</u></strong></a>
          <p>
