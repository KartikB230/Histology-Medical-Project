      ...
      >
        ...
        <div className="Container1" id="container1">
          <div style={{ position: 'relative' }}>
            <img alt= ""  src="/assets/Images/Muscle/Skeletal Muscle LS Low Magnification.jpg" />
        ...
        <div className='Container2'>
          {/* <a className="image-cell" onClick={() => openPopup1("/assets/Images/Thyroid/Thyroid Pencil diagram without labels.jpg")} style={{ display: "flex", justifyContent: "center", marginBottom: "10px" }}><strong><u>Click Here to view Pencil Diagram of Skeletal Muscle</u></strong></a> */}
          <a className="image-cell" onClick={() => openPopup1("/assets/Images/Muscle/Skeletal Muscle LS High Magnification.jpg")} style={{ display: "flex", justifyContent: "center", marginBottom: "10px" }}><strong><u>Click Here to view High Magnification of Skeletal Muscle LS</u></strong></a>
