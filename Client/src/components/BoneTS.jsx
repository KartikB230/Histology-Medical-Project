    ...
    <>
      <div>
        ...
        <div className="Container1" id="container1"  onTouchStart={handleTouchStart} onTouchMove={handleTouchMove} onTouchEnd={handleTouchEnd}>
          ...
          <button className="AllButtons" data-tooltip="Interstitial lamellae" id="TSbtn4" data-popup="popup4" onClick={() => openPopup1("/assets/Images/Bone/TS_canaliculii.png")}>4</button>
          <button className="AllButtons" data-tooltip="Haversian Canal" id="TSbtn5" data-popup="popup5">5</button>
          <button className="AllButtons" data-tooltip="Osteon (Haversian System)" id="TSbtn6" data-popup="popup6" onClick={() => openPopup1("/assets/Images/Bone/TS_osteon.png")}>6</button>
          <button className="AllButtons" data-tooltip="Osteocyte" id="TSbtn7" data-popup="popup7" onClick={() => openPopup1("/assets/Images/Bone/TS_canaliculii.png")}>7</button>
        </div>
