      ...
      <Navbar />
        ...
        <div className= "Container1"  id="container1">
          <div style={{ position: 'relative' }}>
            <img src="/assets/Images/Muscle/Skeletal Muscle Low Magnification.jpg" alt="Skeletal Muscle" />
        ...
        <div className= 'Container2'>
          <a href='#' className="image-cell" onClick={() => openPopup1("/assets/Images/Muscle/Skeletal Muscle High Magnification.jpg", "")} style={{ display: "flex", justifyContent: "center", marginBottom: "10px" }}><strong><u>Click Here to view High Magnification of Skeletal Muscle</u></strong></a>
