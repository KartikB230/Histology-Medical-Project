      ...
      <Navbar />
        ...
        <div className= "Container1"  id="container1">
          <div style={{ position: 'relative' }}>
            <img src="/assets/Images/Urinary System/Ureter Low Magnification.jpg" alt="Ureter" />
        ...
        <div className= 'Container2'>
          <a href='#' className="image-cell" onClick={() => openPopup1("/assets/Images/Urinary System/Ureter High Magnification.jpg")} style={{ display: "flex", justifyContent: "center", marginBottom: "10px" }}><strong><u>Click Here to view Panaromic Diagram of Ureter</u></strong></a>
