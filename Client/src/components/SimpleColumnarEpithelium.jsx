      ...
      <div>
        ...
        <div className="Container1" id="container1" onTouchStart={handleTouchStart} onTouchMove={handleTouchMove} onTouchEnd={handleTouchEnd}>
          <div style={{ position: 'relative' }}>
            <img alt= ""  src="assets/Images/Epithelium/Simple Columnar Low Magnification.jpg" />
        ...
        <div className='Container2'>
          <a className="image-cell" onClick={() => openPopup1("assets/Images/Epithelium/Simple Columnar Pencil.png")} style={{ display: "flex", justifyContent: "center", marginBottom: "10px" }}><strong><u>Click Here to view Pencil Diagram of Simple Columnar Epithelium</u></strong></a>
          <p>
