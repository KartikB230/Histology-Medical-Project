      ...
      >
        ...
        <div className="Container1" id="container1">
          <div style={{ position: 'relative' }}>
            ...
            <button className="AllButtons" data-tooltip="Pars Distalis" id="Pituitarybtn3" data-popup="popup3" onClick={() => openPopup('/assets/Images/Pituitary/Pars Distalis.png', 'The pars anterior is covered by a capsule which is derived from the inner layer of dura mater. <br/>It contains cords of cells which branch and anastomose. The cells are supported by a thin basement membrane which is made of reticular tissue. <br/>Two types of cells are found in pars anterior -<br/>&emsp;<strong>i. Chromophobes</strong> - It makes up 50% of the cell population of pars anterior.<br/><strong>&emsp;ii. Chromophils</strong> - consists of two further subtypes of cells, acidophils (35%) and basophils (15%).', '/assets/Audios/Endocrine/Pars anterior ( pituitary).m4a', true)}>3</button>
