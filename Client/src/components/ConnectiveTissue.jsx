...
const ConnectiveTissue = () => {
  ...
  useEffect(() => {
    ...
    if (activeTab === 'Types of Connective Tissue' && searchInputRef.current && window.innerWidth > 1000) {
  ...
  return (
    <div>
      ...
      <div className="tab-container">
        ...
        <button className="tab-button" onClick={() => setActiveTab('Types of Connective Tissue')}>Types of Connective Tissue</button>
