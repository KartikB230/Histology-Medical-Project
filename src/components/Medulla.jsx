...
import '../medula.css'; // Import your CSS file
...
function Medulla() {
  ...
  return (
    <>
      ...
      <div className='box'>
        <div class="heading">
          <h1 style={{ "margin": "10px" }}>Kidney - Medulla</h1><hr style={{ "height": "10px" }} />
        </div>

        <div id="labels" className="labels">

          <div className="img">
            <img src="/assets/Images/Kidney/Medulla_a.jpg" alt="Medulla" />
