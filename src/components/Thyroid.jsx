      ...
      <div class="heading">
        ...
        <div id="labels" className="labels">
          ...
          <div id = "buttons">
            ...
            <button className="button4" data-tooltip="Follicular cells (Simple cuboidal epithelium)" data-popup = "popup4" onClick={() => openPopup1('/assets/Follicular_cells_parafollicular_cells.tif','The lining epithelium of the follicles shows cuboidal cells which stain eosinophilic. These cells have a vesicular round nucleus. They constitute the principal secretory cells of thyroid which synthesize thyroglobulin.','/assets/Audios/Follicular_cells.wav' )}>4</button>
            <button className="button5" data-tooltip="Parafollicular or C cells " data-popup = "popup5" onClick={() => openPopup1('/assets/Follicular_cells_parafollicular_cells.tif','These cells constitute about 2% of the thyroid gland. The cells are called as clear cells because the cytoplasm is not stained. The cells are large and occur either singly or in groups of 2 or 3. They are usually situated between the basement membrane and the cubical epithelium. They secrete calcitonin.','/assets/Audios/Parafollicular_cells.wav')}>5</button>
            <button className="button6" data-tooltip="Colloid" data-popup = "popup6" onClick={() => openPopup1('/assets/Connective_Tissue_Septa_Colloid.tif','The lumen of the thyroid follicle is large and contains colloid which is stained eosinophilic It is made of a glycoprotein complex, also known as thyroglobulin. The colloid stains with both acidic and basic dyes. It is strongly PAS positive. ','/assets/Audios/Colloid.wav')}>6</button>
          </div>
        </div>
