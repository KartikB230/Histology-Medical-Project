  ...
  return (
    <div>
        ...
        <div className="info-container">
          <div className="info-content">
            ...
            <div className="audio-container">
              <audio style={{ padding: '30px' }} controls>
                <source src="/assets/h1_76 squamous epithelium (1).wav" type="audio/wav" />
      ...
      <div id="popup1" className="popup">
        <button className="close-button" data-popup="popup1" onClick={(event) => closePopup(event.target)}
>&times;</button>
